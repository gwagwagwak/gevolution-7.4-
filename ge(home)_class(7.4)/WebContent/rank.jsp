...
<!--바로 reviewAction.jsp로 보낸다.  -->
				...
				<div class="modal-body" style="background-color: ivory">
					<form action="reviewAction.jsp" method="post" class="form-horizontal">

						<div class="form-group" >
							<label for="inputId3" class="col-sm-3 control-label">* 게임</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="inputId3" name="id" value="<%=game_name%>" readonly>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" class="form-control" id="inputPassword3"
									name="pw"value="<%=mdao.getNickuseid(id)%>" readonly>
							</div>
						</div>
<!--별점 -->
						 <div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<textarea class="form-control" placeholder="글 내용" name="content" maxlength="1000" style="height:200px"></textarea>
