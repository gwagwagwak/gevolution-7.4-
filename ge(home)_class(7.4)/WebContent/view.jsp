	...
	<div class="container">
		<div class="row">
			...
			<table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
				...
				</tbody>	<%-- <%=board.getContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %> --%>
			</table>
			<a href="bbs.jsp" class="btn btn-primary">목록</a>
		<%
			if(id != null && md.getNickuseid(id).equals(board.getNickname())){
				%>
				<a href="update.jsp?b_id=<%=b_id%>" class="btn btn-primary">수정</a>
				<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?b_id=<%=b_id%>" class="btn btn-primary">삭제</a>
			<%
			}
