...
<body>
	...
	if (request.getAttribute("r_pageNumber") != null) {
		String srpg = request.getAttribute("r_pageNumber").toString();
		r_pageNumber = Integer.parseInt(srpg); 
		System.out.println("받아온 리뷰 페이지 : "+r_pageNumber);
	}else{
		System.out.println("리뷰 페이지 못받아옴");
	}
...
%>
	...
	<div class="container">
		<div class="row">
			...
			<%
				if(r_pageNumber != 1) {
			%>
			<a href="bbsAction.do?pageNumber=<%=r_pageNumber - 1%>"
				class="btn btn-success btn-arraw-left">이전</a>
			<%
				}
				if (bdao.nextPage(r_pageNumber + 1)) {
					if(bdao.getTotal() > 10){
			%>
			<a href="bbsAction.do?pageNumber=<%=r_pageNumber + 1%>"
	...
	<button class="btn btn-primary" data-target="#myModal" data-toggle="modal">리뷰 작성하기</button><br/>
...
<!--바로 reviewAction.jsp로 보낸다.  -->
				...
				<div class="modal-body" style="background-color: ivory">
					<form action="reviewAction.do" method="post" class="form-horizontal">

						<div class="form-group" >
							<label for="inputId3" class="col-sm-3 control-label">* 게임</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="inputId3" name="game_name" value="<%=game_name%>" readonly>
							</div>

						</div>

						<div class="form-group">
							<label for="inputPassword3" class="col-sm-3 control-label">* 닉네임</label>
							<div class="col-sm-6">
...
<!--별점 -->
						 <div class="form-group">
							<label for="inputPassword3" class="col-sm-3 control-label">* 평점</label>
							<div class="col-sm-6">
						...
						<script>
							/* $('.starRev span').click(function(){
								...
								var starRating = function(){
									  ...
									  $(document)
									    .on("focusin", ".star_input>.input", function(){
									    $(this).addClass("focus");
									  })
						...
						<div class="form-group">
							<label for="inputName3" class="col-sm-3 control-label">*평가 남기기</label>
							<div class="col-sm-6">
								<textarea class="form-control" placeholder="글 내용" name="r_content" maxlength="1000" style="height:200px"></textarea>
